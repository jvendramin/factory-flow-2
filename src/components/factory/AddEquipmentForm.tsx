...
const AddEquipmentForm = ({
  ...
  return <form onSubmit={handleSubmit} className="p-4 space-y-4 overflow-y-auto max-h-[80vh]">
      ...
      <div className="grid gap-4">
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="name" value={newEquipment.name || ''} onChange={e => handleChange("name", e.target.value)} className="col-span-3" required />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="type" value={newEquipment.type || ''} onChange={e => handleChange("type", e.target.value)} className="col-span-3" required />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="description" value={newEquipment.description || ''} onChange={e => handleChange("description", e.target.value)} className="col-span-3" />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="cycleTime" type="number" value={newEquipment.cycleTime || ''} onChange={e => handleNumberChange("cycleTime", e.target.value)} className="col-span-3" required />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="maxCapacity" type="number" min="1" value={newEquipment.maxCapacity || 1} onChange={e => handleNumberChange("maxCapacity", e.target.value)} className="col-span-3" />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="throughput" type="number" value={newEquipment.throughput || ''} onChange={e => handleNumberChange("throughput", e.target.value)} className="col-span-3" required />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="width" type="number" value={newEquipment.dimensions?.width || ''} onChange={e => handleDimensionChange("width", e.target.value)} className="col-span-3" required />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="height" type="number" value={newEquipment.dimensions?.height || ''} onChange={e => handleDimensionChange("height", e.target.value)} className="col-span-3" required />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="setupTime" type="number" value={newEquipment.setupTime || ''} onChange={e => handleNumberChange("setupTime", e.target.value)} className="col-span-3" />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="maintenanceInterval" type="number" value={newEquipment.maintenanceInterval || ''} onChange={e => handleNumberChange("maintenanceInterval", e.target.value)} className="col-span-3" />
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="energy" type="number" value={newEquipment.energy || ''} onChange={e => handleNumberChange("energy", e.target.value)} className="col-span-3" />
        </div>
