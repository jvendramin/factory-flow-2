...
const LiveStatsPanel = ({ nodes, edges }: LiveStatsPanelProps) => {
  ...
  useEffect(() => {
    ...
    if (bottleneckNode) {
      ...
      const adjustedBottleneckTime = bottleneckMaxCapacity > 1 ? 
        bottleneckCycleTime / bottleneckMaxCapacity : bottleneckCycleTime;
