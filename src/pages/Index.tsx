  ...
  return <div className="flex h-screen w-full overflow-hidden bg-background">
      ...
      <div className="w-64 border-r border-border bg-sidebar flex flex-col">
        <div className="p-4 border-b border-border flex items-center justify-between">
          <h1 className="text-lg">Factory Flow</h1>
        ...
        <div className="border-b border-border p-2 flex justify-end">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-auto">
            <TabsList className="gap-1 bg-transparent">
              <TabsTrigger value="editor" className="rounded-full data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-none">
                Editor
              </TabsTrigger>
              <TabsTrigger value="analytics" className="rounded-full data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-none">
                Analytics
              </TabsTrigger>
